...
// Strip out header, footer, scripts, styles, meta, EJS comments/tags
...
// Replace onclick navigation with navigate()
jsxContent = jsxContent.replace(/onclick="window\.location\.href='([^']+)'"/gi, 'onClick={() => navigate("$1")}');
...
console.log('Courses.jsx properly generated!');
